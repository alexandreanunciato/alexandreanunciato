...
- **[Escrevendo Classes de um Jogo](https://github.com/alexandreanunciato/escrevendo-classes-jogo-js)** - Projeto desenvolvido em **JavaScript**, com foco em lógica de programação e conceitos básicos de programação orientada a objetos, utilizando classes, objetos e métodos para simular ataques de um herói conforme seu tipo.
